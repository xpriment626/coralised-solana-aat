...
const SYSTEM_PROMPT = `You are solana-vulnhunter, a specialised Solana agent.
...
- Always identify yourself as "solana-vulnhunter" in your messages.
`;

runCoralAgent({
  name: "solana-vulnhunter",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/vulnhunter/SKILL.md",
});
