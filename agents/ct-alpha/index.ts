...
const SYSTEM_PROMPT = `You are solana-ct-alpha, a specialised Solana agent.
...
- Always identify yourself as "solana-ct-alpha" in your messages.
`;

runCoralAgent({
  name: "solana-ct-alpha",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/ct-alpha/SKILL.md",
});
