...
const SYSTEM_PROMPT = `You are solana-squads, a specialised Solana agent.
...
- Always identify yourself as "solana-squads" in your messages.
`;

runCoralAgent({
  name: "solana-squads",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/squads/SKILL.md",
});
