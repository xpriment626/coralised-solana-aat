...
const SYSTEM_PROMPT = `You are solana-pinocchio, a specialised Solana agent.
...
- Always identify yourself as "solana-pinocchio" in your messages.
`;

runCoralAgent({
  name: "solana-pinocchio",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/pinocchio-development/SKILL.md",
});
