...
const SYSTEM_PROMPT = `You are solana-magicblock, a specialised Solana agent.
...
- Always identify yourself as "solana-magicblock" in your messages.
`;

runCoralAgent({
  name: "solana-magicblock",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/magicblock/SKILL.md",
});
