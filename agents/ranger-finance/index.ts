...
const SYSTEM_PROMPT = `You are solana-ranger-finance, a specialised Solana agent.
...
- Always identify yourself as "solana-ranger-finance" in your messages.
`;

runCoralAgent({
  name: "solana-ranger-finance",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/ranger-finance/SKILL.md",
});
