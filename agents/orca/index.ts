...
const SYSTEM_PROMPT = `You are solana-orca, a specialised Solana agent.
...
- Always identify yourself as "solana-orca" in your messages.
`;

runCoralAgent({
  name: "solana-orca",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/orca/SKILL.md",
});
