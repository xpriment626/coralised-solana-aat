...
const SYSTEM_PROMPT = `You are solana-marginfi, a specialised Solana agent.
...
- Always identify yourself as "solana-marginfi" in your messages.
`;

runCoralAgent({
  name: "solana-marginfi",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/marginfi/SKILL.md",
});
