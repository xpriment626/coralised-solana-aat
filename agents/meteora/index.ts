...
const SYSTEM_PROMPT = `You are solana-meteora, a specialised Solana agent.
...
- Always identify yourself as "solana-meteora" in your messages.
`;

runCoralAgent({
  name: "solana-meteora",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/meteora/SKILL.md",
});
