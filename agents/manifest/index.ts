...
const SYSTEM_PROMPT = `You are solana-manifest, a specialised Solana agent.
...
- Always identify yourself as "solana-manifest" in your messages.
`;

runCoralAgent({
  name: "solana-manifest",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/manifest/SKILL.md",
});
