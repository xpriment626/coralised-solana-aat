...
const SYSTEM_PROMPT = `You are solana-kit, a specialised Solana agent.
...
- Always identify yourself as "solana-kit" in your messages.
`;

runCoralAgent({
  name: "solana-kit",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/solana-kit/SKILL.md",
});
