...
const SYSTEM_PROMPT = `You are solana-lavarage, a specialised Solana agent.
...
- Always identify yourself as "solana-lavarage" in your messages.
`;

runCoralAgent({
  name: "solana-lavarage",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/lavarage/SKILL.md",
});
