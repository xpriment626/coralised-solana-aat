...
const SYSTEM_PROMPT = `You are solana-inco-svm, a specialised Solana agent.
...
- Always identify yourself as "solana-inco-svm" in your messages.
`;

runCoralAgent({
  name: "solana-inco-svm",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/inco-svm/SKILL.md",
});
