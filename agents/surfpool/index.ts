...
const SYSTEM_PROMPT = `You are solana-surfpool, a specialised Solana agent.
...
- Always identify yourself as "solana-surfpool" in your messages.
`;

runCoralAgent({
  name: "solana-surfpool",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/surfpool/SKILL.md",
});
