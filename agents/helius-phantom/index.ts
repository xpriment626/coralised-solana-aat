...
const SYSTEM_PROMPT = `You are solana-helius-phantom, a specialised Solana agent.
...
- Always identify yourself as "solana-helius-phantom" in your messages.
`;

runCoralAgent({
  name: "solana-helius-phantom",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/helius-phantom/SKILL.md",
});
