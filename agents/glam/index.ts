...
const SYSTEM_PROMPT = `You are solana-glam, a specialised Solana agent.
...
- Always identify yourself as "solana-glam" in your messages.
`;

runCoralAgent({
  name: "solana-glam",
  systemPrompt: SYSTEM_PROMPT,
  skillUrl: "https://raw.githubusercontent.com/sendaifun/skills/main/skills/glam/SKILL.md",
});
